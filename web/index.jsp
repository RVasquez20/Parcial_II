  ...
  <path fill-rule="evenodd" d="M9.5 1h-3a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3zM8 7a.5.5 0 0 1 .5.5V9H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V10H6a.5.5 0 0 1 0-1h1.5V7.5A.5.5 0 0 1 8 7z"/>
    ...
    <script type="text/javascript">
                                        $('#tbl_Productos').on('click', 'tr td', function (evt) {
                                            ...
                                            $("#txt_ID").show();
                                            $("#ID1").show();
                                            var target, idProductos, Productos, Descripcion, PrecioCosto, PrecioVenta,IdMarcas, Existencias;
                                            target = $(event.target);
                                            
                                            idProductos = target.parent().data('idestudiantes');
                                            
                                            idSangre = target.parent().data('id_sangre');
                                            Productos = target.parents("tr").find("td").eq(0).html();
                                            ...
                                            IdMarcas = target.parent("tr").find("td").eq(6).html();
